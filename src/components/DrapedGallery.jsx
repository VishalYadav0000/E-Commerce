...
const DrapedGallery = () => {
  return (
    <div className="my-10">
      ...
      <div className="flex flex-col md:flex-row gap-6 justify-center px-4 md:px-10">

        <div className="relative w-full md:w-[466px] h-[320px] md:h-[620px] border-2 border-pink-500 rounded-xl overflow-hidden">
        ...
        <div className="flex flex-col gap-4">
          <div className="flex gap-4">
            <div className="w-full sm:w-[302px] md:w-[302px] h-[302px]">
              <img
            ...
            <div className="w-full sm:w-[496px] md:w-[496px] h-[302px]">
              <img
